...
describe('Trickle - v5.0.0 to v5.1.0', async () => {
  ...
  updatePlugin('Trickle - update to v5.1.0', { name: 'adapt-contrib-trickle', version: '5.1.0', framework: '">=5' });
});
...
describe('Trickle - v5.1.0 to v5.1.1', async () => {
  ...
  updatePlugin('Trickle - update to v5.1.1', { name: 'adapt-contrib-trickle', version: '5.1.1', framework: '">=5' });
});
